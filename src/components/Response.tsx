    ...
    <section className="flex flex-col gap-3 h-[435px] overflow-y-scroll active-scroll absolute pr-5 bg-transparent">
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-3">
          ...
          <span className="flex-1 pl-4 py-7 text-white font-popins font-bold text-sm border border-grayColor/50 rounded-2xl">
        ...
        <div className="flex items-start gap-3 ">
          <span className="border border-grayColor/50 rounded-2xl p-[14px]">
            <FaRobot className="text-white h-12 w-12" />
          </span>
          <div className="flex flex-col justify-between border border-grayColor/50 rounded-2xl px-4 py-7  overflow-y-scroll active-scroll">
